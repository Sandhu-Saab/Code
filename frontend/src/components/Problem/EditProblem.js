...
function EditProblem() {
  ...
  const [ticketNumber, setTicketNumber] = useState([{problemId: "placeholder"}])
  ...
  function getProblemData() {
    axios({
      ...
      .then((response) => {
        ...
        setTicketNumber("PRB" + data.ticketNumber.toString().padStart(6, "0"));
      })
      .catch((error) => {
        if (error.response) {
...
function getStatusList(){
 ...
 const getGroups = async () => {
  ...
  function setData() {
    ...
    setReportDateTime(problemData.reportDateTime);
 ...
 */
 function getUsername(ownerId) {
  return userList.find(
    (item) => item.id === problemData.ticketOwnerId
  ).username
}
...
function getUserFullName(userId) {
  ...
  document.title = "Problem Ticket #" + problemId + " - PiXELL-River";
                  ...
                  <Box pt={3}>
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={4}>
                        ...
                        <Box pt={2}>
                          <Autocomplete
                            defaultValue={getTechFullName(problemData.assignedTechId)}
                      ...
                      <Grid item xs={4}>
                        <LocalizationProvider dateAdapter={AdapterDateFns}>
                          <DateTimePicker
                            ...
                            value={problemData.ticketDateTime}
                            renderInput={(params) => (
                      ...
                      <Box pt={2}>
                          ...
                          defaultValue={problemGroup.find(
                            (item) =>
                              item.securityGroupId === problemData.security_group
                          )}
                  ...
                  <Box pt={2}>
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={10}>
                        ...
                        <Box pt={3}>
                          <DeleteDependencies problems={problemData}
                          users = {userList}/>
                        </Box>
