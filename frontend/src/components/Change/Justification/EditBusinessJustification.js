...
function EditBusinessJustification({
    id,
                            ...
                            <Grid item xs={4}>
                                <LocalizationProvider dateAdapter={AdapterDateFns}>
                                    <DateTimePicker
                                        ...
                                        value={justificationDetails.startDate}
                            ...
                            <Grid item xs={4}>
                                <LocalizationProvider dateAdapter={AdapterDateFns}>
                                    <DateTimePicker
                                        ...
                                        name="endDate"
                                        inputFormat="MM/dd/yyyy"
                                        value={justificationDetails.endDate}
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={4}>
                                <TextField
                                    ...
                                    name="purpose"
                                    rows={5}
                                    defaultValue={justificationDetails.purpose}
                            ...
                            <Grid item xs={4}>
                                <TextField
                                    ...
                                    name="need"
                                    rows={5}
                                    defaultValue={justificationDetails.need}
                                    onChange={onRequestJustificationChange}
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={4}>
                                <TextField
                                    ...
                                    name="duration"
                                    rows={5}
                                    defaultValue={justificationDetails.duration}
                                    onChange={onRequestJustificationChange}
                            ...
                            <Grid item xs={4}>
                                <TextField
                                    ...
                                    name="accessibility"
                                    rows={5}
                                    defaultValue={justificationDetails.accessibility}
                                    onChange={onRequestJustificationChange}
...
export default EditBusinessJustification;